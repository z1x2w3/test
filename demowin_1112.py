...
class win(QtWidgets.QWidget):
    ...
    def init_ui(self):
        ...
        self.test_list_dict = {}
        self.test_data_dict = {}
        self.gv_1 = self.ui.graphicsView
        self.gv_2 = self.ui.graphicsView_2
        self.gv_3 = self.ui.graphicsView_3
        self.sql_list = self.ui.listWidget
        self.sql_view = self.ui.tableWidget
        self.sql_bn = self.ui.pushButton_9

        self.tab_widget = self.ui.tabWidget
        self.test_bn = self.ui.pushButton
        self.test_plot_bn = self.ui.pushButton_6
        self.test_clear_bn = self.ui.pushButton_7
        self.test_ok_bn = self.ui.pushButton_8
        self.test_list = self.ui.listWidget_2
        self.material_edit = self.ui.lineEdit
        self.temperature_edit = self.ui.lineEdit_2
        self.select_browser = self.ui.textBrowser

        self.test_cbb = self.ui.comboBox
        self.tx_cae_bn = self.ui.pushButton_2
        self.tx_cae_list = self.ui.listWidget_3
        self.tx_plot_bn = self.ui.pushButton_3
        self.tx_clear_bn = self.ui.pushButton_4
        ...
        self.test_cbb_2 = self.ui.comboBox_2
        self.qf_cae_bn = self.ui.pushButton_5
        self.qf_cae_list = self.ui.listWidget_4
        self.qf_plot_bn = self.ui.pushButton_10
        self.qf_clear_bn = self.ui.pushButton_11
        ...
        self.test_cbb_3 = self.ui.comboBox_3
        self.yh_cae_bn = self.ui.pushButton_12
        self.yh_cae_list = self.ui.listWidget_5
        self.yh_plot_bn = self.ui.pushButton_13
        self.yh_clear_bn = self.ui.pushButton_14
    ...
    def import_db(self,index):
        if index == 1:
            conn = sqlite3.connect(r'.\2\test_sqlite.db') #连接高低温物性测量数据库
